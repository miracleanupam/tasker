...
class UserTest < ActiveSupport::TestCase
  ...
  test "user email should not validate improper emails" do
    improper_emails = %w[ram@gmail @yahoo.com abc.example.com abc@def@gmail.com a(sdklfd).city@gmail.com just"not"right.example.com hello\world@gmai.com]

    improper_emails.each { |e|
      @user.email = e
      assert @user.invalid?
    }
  end
  ...
  test "password should have a minimum length" do
    @new_user = User.new(name: "hello", email: "hello@world.com", admin: false, password: "foo", password_confirmation: "foo")
